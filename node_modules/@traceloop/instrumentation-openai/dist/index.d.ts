...
type ImageUploadCallback = (traceId: string, spanId: string, filename: string, base64Data: string) => Promise<string>;
...
export type { ImageUploadCallback, OpenAIInstrumentationConfig };
