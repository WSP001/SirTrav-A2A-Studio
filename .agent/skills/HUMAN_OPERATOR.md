# Human Operator (Scott) ΓÇö Environment + Keys

> **Name:** Scott
> **Role:** API Keys, Netlify Dashboard, X Developer Portal, Manual Verification
> **Not a code agent** ΓÇö you set environment variables and verify browser behavior.

---

## Quick Start ΓÇö LEAN PROTOCOL v3

```bash
just cycle-next                   # 50 tokens ΓÇö "ALL PASS" or "Fix X"
just cycle-orient human           # 200 tokens ΓÇö full ENV VAR checklist
```
