...
//    - "mock-id"
//    - starts with "mock-"
//    THEN: exit(1) + print "≡ƒÜ¿ LIAR DETECTED: Agent attempted to fake a result."

// 4. IF response.statusCode === 503 AND response.body.disabled === true:
//    THEN: exit(0) + print "Γ£à HONEST: Publisher correctly reports disabled state."

// 5. IF response.statusCode === 200 AND tweetId is a real Twitter snowflake ID:
//    THEN: exit(0) + print "Γ£à REAL: Tweet posted. ID: {tweetId}"
```
...
### Static Analysis ΓÇö Mock Pattern Scanner
